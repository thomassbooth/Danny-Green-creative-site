...
const Project: React.FC<projectProps> = ({setModal, index, title, place, year}) => {
  return (
    <div className = 'group hover:opacity-50 flex w-full justify-between items-center py-[4vh] px-[50px] border-t border-[#C9C9C9] transition-all duration-200 cursor-pointer last-of-type:border-b'
